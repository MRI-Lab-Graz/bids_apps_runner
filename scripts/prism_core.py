...
def detect_execution_mode(config: Dict[str, Any], force_mode: Optional[str] = None) -> str:
...
def run_command(cmd: list, capture_output: bool = True, check: bool = True, 
                dry_run: bool = False, cwd: Optional[str] = None) -> Any:
