...
print_usage() {
    ...
    echo "   # OR"
    echo "   bash scripts/activate_appsrunner.sh"
    echo ""
    echo "2. Test the installation:"
    echo "   python scripts/run_bids_apps.py --help"
    echo "   python scripts/run_bids_apps_hpc.py --help"
    echo ""
    echo "3. Configure your BIDS app:"
    echo "   cp configs/config_example.json config.json"
    ...
    echo "   - docs/README_HPC_DATALAD.md (HPC-specific usage)"
    echo ""
